    ...
    return (
        <>
            <div className="my-4 py-4" id='portfolio'>
                <h2 className="my-2 text-center text-3xl text-blue-900 uppercase font-bold">Your Medical Billing Should Not Stress You Out</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 justify-items-center">                            
                        <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:scale-105 rounded-lg shadow-2xl p-3 min-h-max">
                            <div className="m-2 text-justify text-sm">
                                <h4 className="font-semibold my-4 text-lg md:text-2xl text-center mb-4 h-12">Get paid faster</h4>
                                <p className="text-md font-medium leading-5 h-auto md:h-48">
                                In the world of Accounts Receivable (AR), timely payments are crucial to maintaining a healthy cash flow. At Sofvie, our AR calling team ensures that your claims are followed up thoroughly, reducing delays and improving your revenue cycle. Our expertise helps businesses and healthcare providers get paid faster by minimizing outstanding receivables, resolving payment issues, and negotiating with insurance companies or clients to clear claims efficiently.
                                </p>
                        ...
                        <div className="bg-white transition-all ease-in-out duration-400 overflow-hidden text-gray-700 hover:scale-105 rounded-lg shadow-2xl p-3">
                            <div className="m-2 text-justify text-sm">
                                <h4 className="font-semibold my-4 text-lg md:text-2xl text-center mb-4 h-12">Create efficiencies</h4>
                                <p className="text-md font-medium leading-5 h-auto md:h-48">
                        ...
                        <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:scale-105 rounded-lg shadow-2xl p-3">
                            <div className="m-2 text-justify text-sm">
                            <h4 className="font-semibold my-4 text-lg md:text-2xl text-center mb-4 h-12">Increase Profitability</h4>
                                <p className="text-md font-medium leading-5 h-auto md:h-48">
